...
*Главная страница с виниловым hero-экраном и каталогом пластинок*
...
*Персональный музыкальный профиль пользователя*

### AI-рекомендации
![AI-рекомендации](screenshots/ai-recommendations.png)
*Умные рекомендации на основе теста и поведения пользователя*
